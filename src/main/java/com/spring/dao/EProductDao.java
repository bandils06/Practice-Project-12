...
public class EProductDao {
	...
	public List<EProductEntity> getProductById(int id) {
		
		return jdbcTemplate.query("select * from eproduct where id=" + id, new RowMapper<EProductEntity>() {
...
//				else return null;
	...
	public void updateProduct(EProductEntity obj) {
		if (obj.getId() > 0) {
			...
			System.out.print("Updation complete");
		} else {
